...
from aitrade.trade.gpt_signal import get_ai_signal
...
class OptimizedCryptoBot:
    def __init__(self, cfg: config.Config):
        ...
        ccxtCfg = {
            ...
            'sandbox': cfg.trade_sandbox_trade,
        ...
        self.trade_log = []
        logging.info(
            "交易所类型:" + cfg.exchange_type + ",代理是否启用:" + str(cfg.proxy_enable) + ",代理地址:" + cfg.proxy_url)
