...
_SIGNAL_SOURCE_DEFINITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        'displayName': '指标信号源',
        'description': '基于主周期 K 线计算 RSI、MACD 等技术指标，并将指标解释结果输出为可复用信号节点。',
        'defaultParams': {
            'indicator_key': 'rsi',
            ...
            'confirm_crossover': True,
            'breakout_lookback': 20,
            'volume_multiplier': 1.1,
        },
        'paramSchema': [
            {'field': 'indicator_key', 'label': '指标标识', 'type': 'string', 'required': True},
            {'field': 'primary_timeframe', 'label': '主周期', 'type': 'string', 'required': True},
            {'field': 'lookback_candles', 'label': '回看K线数', 'type': 'integer', 'required': True, 'min': 30},
            {'field': 'period', 'label': '指标周期', 'type': 'integer', 'required': True, 'min': 2},
            {'field': 'lower_threshold', 'label': '低阈值', 'type': 'number', 'required': True, 'min': 0, 'max': 100},
            {'field': 'upper_threshold', 'label': '高阈值', 'type': 'number', 'required': True, 'min': 0, 'max': 100},
            {'field': 'confirm_crossover', 'label': '要求交叉确认', 'type': 'boolean', 'required': True},
            {'field': 'breakout_lookback', 'label': '突破回看窗口', 'type': 'integer', 'required': True, 'min': 2},
            {'field': 'volume_multiplier', 'label': '放量倍率', 'type': 'number', 'required': True, 'min': 0.1},
        ],
        'schemaVersion': 1,
        'runtimeSupported': True,
    },
